...
def summarize_properties(md: MissingData) -> None:
    ...
    print("-------------------------------")
    top_missing_rate = md.column_missing_rate.sort_values(ascending=False).head(5)
    print("Missing rate:")
    print(top_missing_rate.to_string())
    print("Missing count:")
    print(md.column_missing_count.loc[top_missing_rate.index].to_string())
    print("Missing percent:")
    print(md.column_missing_percent.loc[top_missing_rate.index].round(2).to_string())
    print("Completeness:")
    print(md.column_completeness.loc[top_missing_rate.index].round(3).to_string())
    print()
...
def summarize_methods(md: MissingData) -> None:
    ...
    print("-------------------")
    correlation = md.missing_correlation()
...
def conclusions(md: MissingData) -> None:
    ...
    top_missing_column = md.column_missing_rate.sort_values(ascending=False).head(1)
...
#     top_missing_columns = (
#         md.column_missing_rate.sort_values(ascending=False).loc[lambda s: s > 0].head(3)
#     )
