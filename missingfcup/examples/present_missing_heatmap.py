...
def main():
    ...
    print("\n=== Present vs Missing Correlation Heatmap Demo (10 Examples) ===")

    # ------------------------------------------------------------------
    # 1️⃣ Very easy (minimal)
    # ------------------------------------------------------------------
    md.heatmap_missingness_correlation_present_missing().show()

    # ------------------------------------------------------------------
    # 2️⃣-5️⃣ Simple with personalization
    # ------------------------------------------------------------------
    md.heatmap_missingness_correlation_present_missing(
        selected_columns=["ZIP CODE", "BOROUGH", "OFF STREET NAME", "ON STREET NAME"],
        title="Location Fields (Present vs Missing)",
    ).show()
