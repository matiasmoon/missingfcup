...
def main():
    ...
    print("\n=== Presence Correlation Heatmap Demo (10 Examples) ===")

    # ------------------------------------------------------------------
    # 1️⃣ Very easy (minimal)
    # ------------------------------------------------------------------
    md.heatmap_correlation_present_present().show()

    # ------------------------------------------------------------------
    # 2️⃣-5️⃣ Simple with personalization
    # ------------------------------------------------------------------
    md.heatmap_correlation_present_present(
        selected_columns=["ZIP CODE", "BOROUGH", "OFF STREET NAME", "ON STREET NAME"],
        title="Location Fields (Presence Correlation)",
    ).show()
